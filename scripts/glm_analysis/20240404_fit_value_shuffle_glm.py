...
def calc_and_save_session(sess_name, shuffle_idx):
    ...
    shuffled_beh = glm_utils.create_shuffles(beh, FEATURES, rng)
    ...
    shuffled_res.to_pickle(os.path.join(OUTPUT_DIR, f"{sess_name}_glm_{MODE}_{INTERVAL_SIZE}_{MODEL}_value_shuffle_{shuffle_idx}.pickle"))
