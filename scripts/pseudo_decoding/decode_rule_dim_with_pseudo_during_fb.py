...
def create_session_data(sess_name):
    ...
    splitter = RuleConditionBlockSplitter(trials, condition="RuleDim")
...
def decode_rule(valid_sess):
    ...
    np.save(os.path.join(base_dir, f"rule_dim_not_figured_out_train_accs.npy"), train_accs)
    np.save(os.path.join(base_dir, f"rule_dim_not_figured_out_test_accs.npy"), test_accs)
    np.save(os.path.join(base_dir, f"rule_dim_not_figured_out_shuffled_accs.npy"), shuffled_accs)
    np.save(os.path.join(base_dir, f"rule_dim_not_figured_out_models.npy"), models)
