...
def decode_feedback(valid_sess):
    """
    ...
    # store the results
    np.save(os.path.join(OUTPUT_DIR, f"feedback_train_accs.npy"), train_accs)
    np.save(os.path.join(OUTPUT_DIR, f"feedback_test_accs.npy"), test_accs)
    np.save(os.path.join(OUTPUT_DIR, f"feedback_shuffled_accs.npy"), shuffled_accs)
    np.save(os.path.join(OUTPUT_DIR, f"feedback_models.npy"), models)
